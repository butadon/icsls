		...
		<br/>
			<div class="col-sm-offset-1" id="search_top">
				<form action="<?php echo base_url('index.php/search/search_rm'); ?>" method="get" accept-charset="utf-8">
					...
					<input type="text" name="keyword" size = "30" value="<?php if(isset($_GET['keyword'])) echo htmlspecialchars($this->input->get('keyword'),ENT_QUOTES); ?>"/>
					...
					<a href="<?=base_url().'index.php/cart_controller/view_cart'?>">View Cart</a>
				</form>
