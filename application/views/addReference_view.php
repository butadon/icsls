        ...
        <div id="addReferenceForm">
            ...
            <table class="col-lg-9">
               ...
               <tr>
                ...
                <tr>
                        <td align="right"><button type="button" class="btn btn-primary">Total Available</button></td>
                        <td align="right"><input name="total_available" class="form-control" type="number" id="inputTotalSt" min="1" required> </td>
                </tr>
                 <tr>
                        <td align="right"><button type="button" class="btn btn-primary">Total Stock</button></td>
                        <td align="right"> <input name="total_stock" class="form-control" type="number" id="inputTotalSt" min="1" required> </td>
                </tr>
