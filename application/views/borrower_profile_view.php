			...
			<?=$username_exist?><!--Username Message-->
		        <table id="prof_form">
		            ...
		            <tr>
		                ...
		                <td align="right"> <input type="password" class="form-control" id="repassword" name="repassword" pattern="^[a-zA-Z0-9]{0,32}$" width="3em">
		                <span name="helppass" id="helprepass"></span></td>
		            </tr>
		            <tr>
